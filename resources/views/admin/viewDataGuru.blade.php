                ...
                @foreach ($guru as $g)
                    <tr class="">
                        ...
                        <td class="text-center">
                            ...
                            <form action="{{ url(route('admin.editGuru')) }}" method="GET" class="d-inline">
                                <div class="">
                                    <input class="" type="hidden" name="id" value="{{ $g->id }}">
                                </div>
                                <button type="submit" class="btn  btn-warning waves-effect px-3"><i class="fas fa-edit"
                            ...
                            @if (Auth::user()->master)
                                ...
                                {{ Form::open(['action' => ['App\\Http\\Controllers\\GuruController@delete', $g->id], 'method' => 'DELETE', 'class' => 'd-inline']) }}
                                ...
                                <button type="submit" class="btn  btn-danger waves-effect px-3"
                                    onclick="return confirm('Apakah anda yakin akan menghapus guru?')"><i
