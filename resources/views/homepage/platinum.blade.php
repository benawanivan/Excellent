...
@include('layouts.navbar')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="{{ url('/') }}">Home</a><i class="fa fa-angle-double-right"></i><span>Program Platinum</span>
    ...
    <div id="pricing" class="cards-2">
        ...
        <div class="row">
                <div class="col-lg-12">
                    <h2>Program Les <span class="orange">PLATINUM</span></h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                    ...
                    <div class="card" style="border:none;margin-bottom:0rem;">
                        <div class="card-body" style="padding-bottom:0rem;padding-top:0rem">
                            <ul class="list-unstyled li-space-lg">
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">5 (tiga) kali pertemuan per minggu</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">1.5 jam per pertemuan</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body"><b>FREE</b> kelas tambahan diluar sesi normal</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">Garansi <b>NAIK KELAS</b>*, <b>Garansi NAIK KELAS</b>*, & <b>Garansi LULUS UN</b>*</div>
                                </li>
                            </ul>
                        </div>
                    </div>  
                    ...
                    <div class="card" style="border:none;margin-bottom:0rem;">
                        <div class="card-body" style="padding-bottom:0rem;padding-top:0rem">
                            <ul class="list-unstyled li-space-lg">
                                ...
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">Cambridge Checkpoint (IGCSE<br>O, A/AS Level)</div>
                                </li>
                                <li class="media">
    ...
    <div class="basic-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <h2 style="color: #fff">Interactive Video Conference<br><span class="darkred">DIGITAL WHITEBOARD</span></h2>
                        <p class="white">Pembelajaran online akan tetap efektif seperti pembelajaran offline. Pengajar akan mengajar dengan menggunakan papan tulis digital untuk menampilkan materi dan juga sebagai tempat menulis saat menjelaskan soal. Disertai ilustrasi dan video interaktif semakin mempermudah para siswa untuk memahami materi yang sulit.</p>
                        <p class="white">Materi akan diberikan sesuai dengan kebutuhan dan jumlah siswa yang terbatas dapat membuat siswa semakin fokus dalam belajar.</p>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <div class="image-container">
      ...
      <div class="basic-2" style="padding-bottom: 4rem;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="images/laporan2.png" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <div class="text-container">
