...
@include('templates.navbar')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.html">Home</a><i class="fa fa-angle-double-right"></i><span>Program Platinum</span>
    ...
    <div id="pricing" class="cards-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Paket <span class="orange">PLATINUM</span></h2>
                    <p class="p-heading p-large"><b>5 (lima) kali pertemuan per minggu<br>1,5 jam per pertemuan<br>FREE kelas tambahan diluar sesi normal</b></p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
