...
@include('templates.navbar')
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 style="color: #fff">Program Reguler</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.html">Home</a><i class="fa fa-angle-double-right"></i><span>Program Reguler</span>
    ...
    <div class="basic-2">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="images/whiteboard1.png" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12" style="text-align:center">
                    <a class="btn-solid-white back" href="https://docs.google.com/forms/d/e/1FAIpQLSf_Ffp3yWkq0a9wjgAqQiCIdXTkcKBdJ_WL5xp280HIAyBvew/viewform" style="width:55%">Daftar Sekarang</a>
                </div>
            </div>
        </div> <!-- end of container -->
    </div> <!-- end of basic-2 -->
