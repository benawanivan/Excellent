            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="text-container">
                        ...
                        <br>
                        <h3>Misi</h3>
                        <p>Menjadi lembaga pendidikan terbesar dan terbaik di Indonesia.</p>
                        <br>
                        <h3>Nilai-nilai perusahaan</h3>
                        <ol class="li-space-lg" style="padding-inline-start: 5px;">
                            <li>Mendidik dengan semangat dan sepenuh hati</li>
                            <li>Menciptakan suasana belajar yang menarik dan menyenangkan</li>
                            <li>Belajar terus menerus untuk memiliki pengetahuan yang lebih dalam, memberikan pelayanan yang lebih baik, dan memperoleh kepercayaan yang lebih tinggi</li>
                        </ol>
                    </div> 
                </div>
            </div>
