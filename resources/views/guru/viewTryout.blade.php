    ...
    <div class="container-fluid">
        ...
        <div class="row" style="padding-bottom: 10px;">
                ...
                <div class="container h-100">
                    <div class="d-flex justify-content-left h-100">
                        <div class="searchbar" style="width: -webkit-fill-available;margin-bottom:auto;"> 
                            <form action="{{ route('guru.searchTryout') }}" method="get">
                                {{ csrf_field() }}
            ...
            <div class="col-lg-6" style="justify-content: flex-end;">
                ...
                {{ Form::open(['action' => ['App\\Http\\Controllers\\GuruController@addTryout'], 'method' => 'GET']) }}
                {{ Form::submit('Tambah Tryout', ['class' => 'btn btn-primary']) }}
                {{ Form::close() }}
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-3 col-md-6 col-xs-6 ">
                    <div class="card ">
                        ...
                        <table class="card-footer d-flex align-self-center">
                            ...
                            <td>
                                <div class="row">
                                    <a target="_blank" class="btn btn-primary" href="{{ $row->link }}" role="button" style="height:36.67px">Link</a>
