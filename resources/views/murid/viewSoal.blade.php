                ...
                <div class="col-md-3 col-xs-6">
                    <div class="card ">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <form action="{{route('murid.downloadSoal')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" type="hidden" name="judul" value="{{$s->judul}}">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" type="hidden" name="filename" value="{{$s->file}}">
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="btn  btn-elegant waves-effect px-3"><i class="fas fa-download"
                                            aria-hidden="true" name = 'filename'></i></button>
                                    </div> 
                                </form>
                            ...
                            <p class="card-text"><small class="text-muted text-left">Uploaded {{($s->tgl_buat)}}</small></p>
                        </div>
